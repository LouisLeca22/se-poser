...
async function RentalsPage() {
    ...
    if (rentals.length === 0) {
        return <EmptyList heading='Aucune location à afficher' message="N'&apos;hésitez pas à créer une location" />
    }

    return (
        <div className='mt-16'>
            <h4 className='mb-4'>Annonces actives : {rentals.length}</h4>
            <Table>
                <TableCaption>Liste de vos hébérgements.</TableCaption>
                <TableHeader>
                    <TableRow>
                        <TableHead>Nom de l&apos;hébérgement </TableHead>
                        <TableHead>Tarif par nuit </TableHead>
                        <TableHead>Nuitées réservées </TableHead>
